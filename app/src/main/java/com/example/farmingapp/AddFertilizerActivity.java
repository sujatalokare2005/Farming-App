...
public class AddFertilizerActivity extends AppCompatActivity {

    private static final String TAG = "AddFertilizerActivity";
    ImageView imgSeed;
    ...
    private void initializeViews() {
        etName = findViewById(R.id.etFertilizerName);
        etQuantity = findViewById(R.id.etAvailableQuantity);
        etDescription = findViewById(R.id.etFertilizerDescription);
        etPrice = findViewById(R.id.etFertilizerPrice);
        btnSave = findViewById(R.id.btnSaveFertilizer);
    }
    ...
    private void saveProductToFirebase() {
        ...
        try {
            ...
            reference = database.getReference("Fertilizers");
            ...
            reference.child(productId).setValue(product)
                    .addOnSuccessListener(aVoid -> {
                        ...
                        Toast.makeText(AddFertilizerActivity.this, "Product saved successfully!", Toast.LENGTH_SHORT).show();
                        clearForm();
                    })
                    .addOnFailureListener(e -> {
                        hideProgressDialog();
                        Log.e(TAG, "Failed to save product: " + e.getMessage());
                        Toast.makeText(AddFertilizerActivity.this, "Failed to save product: " + e.getMessage(), Toast.LENGTH_LONG).show();
                    });
