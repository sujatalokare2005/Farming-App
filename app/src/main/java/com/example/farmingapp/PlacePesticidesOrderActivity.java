...
public class PlacePesticidesOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Firebase path for pesticide orders
    ...
    private void placeOrder() {
        ...
        ordersRef.child(orderId).setValue(order)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(this, "कीटकनाशक ऑर्डर यशस्वी!", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(PlacePesticidesOrderActivity.this, ViewPesticidesActivity.class));
                    finish();
                })
