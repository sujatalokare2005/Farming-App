...
public class AddPesticidesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_insecticide);
    ...
    private void initializeViews() {
        etName = findViewById(R.id.etInsecticideName);
        etQuantity = findViewById(R.id.etAvailableQuantity);
        etDescription = findViewById(R.id.etInsecticideDescription);
        etPrice = findViewById(R.id.etInsecticidePrice);
        btnSave = findViewById(R.id.btnSaveInsecticide);
    }
    ...
    private void saveProductToFirebase() {
        ...
        try {
            ...
            reference = database.getReference("Pesticides");
            ...
            reference.child(productId).setValue(product)
                    .addOnSuccessListener(aVoid -> {
                        ...
                        Toast.makeText(AddPesticidesActivity.this, "Product saved successfully!", Toast.LENGTH_SHORT).show();
                        clearForm();
                    })
                    .addOnFailureListener(e -> {
                        hideProgressDialog();
                        Log.e(TAG, "Failed to save product: " + e.getMessage());
                        Toast.makeText(AddPesticidesActivity.this, "Failed to save product: " + e.getMessage(), Toast.LENGTH_LONG).show();
                    });
