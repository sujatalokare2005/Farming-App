...
public class SeeProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSeeds.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(SeeProductsActivity.this, ViewSeedsActivity.class);
            startActivity(intent);
        });

        btnFertilizer.setOnClickListener(v -> {
            // Go to Add Fertilizer Activity (you can create later)
            Intent intent = new Intent(SeeProductsActivity.this, ViewFertilizerActivity.class);
            startActivity(intent);
        });

        btnInsecticide.setOnClickListener(v -> {
            // Go to Add Insecticide Activity (you can create later)
            Intent intent = new Intent(SeeProductsActivity.this, ViewPesticidesActivity.class);
            startActivity(intent);
        });
    }
}
